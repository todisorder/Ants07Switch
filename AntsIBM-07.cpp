...
//static string SwitchAntennae = "Switch";	//"DoNotSwitch";	// "Switch" or "DoNotSwitch"	// like this it is defined here, not asked.

static string SwitchAntennae; 		// like this it is asked.
...
unsigned seed1 = 3297917212;                   // To use same seed as another simulation.
...
//  Droplet amounts
static double const DropletAmountPerUnitTime = 0.*1.*1.*1.;        //0.00001
...
void PrintInfo(double delta_t, string COMM, Numerics data){
    ...
    tempfile << "------------------------------------------------------" << endl;
    tempfile << "ANTENNAE ARE SWITCHED?? ---" << SwitchAntennae << "---" << endl;
...
int main (void){
    ...
    for (int antnumber=0; antnumber < totalantnumber; antnumber++) {
        ...
        //Pop[antnumber].AntVelX = 0.;
        //Pop[antnumber].AntVelY = 0.5;
